...
const Header = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 bg-transparent backdrop-blur-md text-white shadow-lg py-4 z-50 border-t border-white/20 border-b border-white/10">
